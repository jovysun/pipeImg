...
class PipeImg {
    ...
    constructor(options) {
        ...
        this.$saveBtn = $(this.options.saveBtn);
    ...
    init() {
        ...
        loadImage(this.source, (img) => {
            sourceImgEle.src = img.src;
            sourceImgEle.style.width = 'auto';
            sourceImgEle.style.height = 'auto';

            cacheSource = this.source;
        ...
        this.$saveBtn.addEventListener('click', () => {
            let pipeImg = new ImgHandler({
                sourceImg: sourceImgEle
            })
        }, false)
